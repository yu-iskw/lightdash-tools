...
- **Slim ADRs:** Binding decisions live under [`docs/adr`](docs/adr) (currently 0001–0016); see the old→new mapping in [`docs/adr/README.md`](docs/adr/README.md).
