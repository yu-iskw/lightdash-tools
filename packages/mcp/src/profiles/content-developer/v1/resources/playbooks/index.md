...
| Recovery: PREVIEW_STALE                                      | `lightdash://playbooks/content-developer/recovery/preview-stale`    |
| Recovery: PREVIEW_REQUIRED                                   | `lightdash://playbooks/content-developer/recovery/preview-required` |
| Recovery: dashboard preview diff                             | `lightdash://playbooks/content-developer/recovery/dashboard-diff`   |
