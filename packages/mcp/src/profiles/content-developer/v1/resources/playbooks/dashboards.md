...
- After cull / professionalize: report untiled dashboard-owned chart UUIDs; soft-delete via **content-governance** (not this profile).
- Report dashboard UUID/slug, tiles, and chart UUIDs/slugs; note execution was unavailable on this profile.
