...
const playbooks = defineProfilePlaybooks<ContentDeveloperPlaybookTopic>({
  ...
  topics: [
    ...
    },
    {
      ...
      useWhen: 'After PREVIEW_STALE (hash mismatch or baseline drift)',
    },
    {
      ...
      useWhen: 'After PREVIEW_REQUIRED (missing, invalid, or expired token)',
    },
    {
      ...
      useWhen: 'When interpreting dashboard preview diff.removed noise vs omissions',
    },
  ],
});
