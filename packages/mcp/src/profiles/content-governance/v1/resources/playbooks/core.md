...
- Do not restore, author, compile queries, or execute warehouse SQL from this profile.
...
3. Never enumerate organization projects from this profile (no `list_projects`).
