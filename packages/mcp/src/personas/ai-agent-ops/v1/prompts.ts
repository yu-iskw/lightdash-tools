...
/* eslint-disable @typescript-eslint/no-deprecated -- matches other persona prompt registration */
import { z } from 'zod';
...
Use MCP for inspect/eval runs; CLI agentops for bundle apply and gates; other personas for semantic/content when available.
