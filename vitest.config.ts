  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'packages/semantic-layer-mcp/src/bin.ts',
        'packages/semantic-layer-mcp/src/index.ts',
        'packages/semantic-layer-mcp/src/http.ts',
        'packages/semantic-layer-mcp/src/transports/streamable-http.ts',
