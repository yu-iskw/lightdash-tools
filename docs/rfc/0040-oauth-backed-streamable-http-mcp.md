...
| `LIGHTDASH_TOOLS_MCP_ALLOWED_ORIGINS`               | `MCP_ALLOWED_ORIGINS`              |                                                                              empty | Comma-separated CORS origin allowlist. Empty blocks browser Origin reflection unless `LIGHTDASH_TOOLS_MCP_DANGEROUSLY_ALLOW_ANY_ORIGIN=1`. Production `lightdash-oauth` requires an allowlist or the dangerous override. |
