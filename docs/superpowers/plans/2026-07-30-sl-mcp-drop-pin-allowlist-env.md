...
| Env prefix        | [ADR-0035](../../docs/adr/0035-environment-variables-prefix-lightdash-tools.md)                                                                     | Remove unused `LIGHTDASH_TOOLS_*` rather than keep dead stdio adaptations                                                                            |
