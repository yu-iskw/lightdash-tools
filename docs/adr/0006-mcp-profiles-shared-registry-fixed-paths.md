...
Amended by profile boundary ADRs (0010, 0012, 0014, 0015, 0017, 0018, 0020) and catalog SSOT ([ADR-0013](0013-operation-catalog-as-sole-agent-surface-ssot.md)).
...
6. Stdio selects a profile via **explicit subcommand** (or `LIGHTDASH_TOOLS_MCP_STDIO_PROFILE`). Default is `semantic-layer`. Envelope field is `context.profile`.
