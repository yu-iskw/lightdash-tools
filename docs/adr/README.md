...
31. [MCP OAuth downstream client consent](0032-mcp-oauth-downstream-client-consent.md)
32. [MCP HTTP production fail-closed profile allowlist](0033-mcp-http-production-fail-closed-profile-allowlist.md)
