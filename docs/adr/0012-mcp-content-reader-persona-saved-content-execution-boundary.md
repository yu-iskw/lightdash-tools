...
9. Shared tool implementations live under `packages/mcp/src/tools/`; the persona owns `toolIds`, prompts, playbook, and capability asserts. Endpoint map: [content-reader inventory](../profiles/content-reader/inventory.md).
