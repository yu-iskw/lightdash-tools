...
2. **Project scope** matches content-reader precedence: `X-Lightdash-Project` → tool `projectUuid` → `PROJECT_SCOPE_REQUIRED`. Tool args cannot override pin. Optional ceiling: `LIGHTDASH_TOOLS_ALLOWED_PROJECTS`.
3. **Hybrid authoring:**
