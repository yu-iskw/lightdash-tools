...
7. Stdio selects the profile via explicit subcommand (`lightdash-mcp organization-audit`) or `LIGHTDASH_TOOLS_MCP_STDIO_PROFILE`; bare `lightdash-mcp` remains `semantic-layer` ([ADR-0006](0006-mcp-profiles-shared-registry-fixed-paths.md)).
