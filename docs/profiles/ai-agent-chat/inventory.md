...
See [ADR-0029](../../adr/0029-mcp-ai-agent-chat-profile-conversation-boundary.md) (amended by [ADR-0030](../../adr/0030-mcp-ai-agent-chat-first-turn-requires-prompt-on-create.md)).
...
Host guidance (prompts/playbooks): **new conversation by default**; continue only with a known own-thread UUID. Do not teach cross-user thread takeover (`allUsers` stays off MCP v1).
